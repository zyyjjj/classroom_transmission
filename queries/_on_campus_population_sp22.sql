...
declare @start_date datetime = '2022-02-07'
declare @datefrom datetime = '2022-02-06'
declare @dateto datetime = '2022-02-21'
...
t_students as (
	...
	-- left join checklist_plan c on p.employee_id_hash = c.emplid_hash
	where academic_term_sdescr = '2022SP'
...
NAPs as (
	...
	and cast(hd_notify_date as date) between '2021-11-09' and '2022-02-06'
),
...
-- select * from t_positives
-- select * from positives_by_day order by hd_notify_date
